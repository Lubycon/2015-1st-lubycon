...
<body id="bodyer" ondragstart="return false" onselectstart="return false">
    ...
    <div class="editer_popup">
        ...
        <ul>
            <li>
                <a href="http://localhost/html-php/index.php?1=editer&2=editer&3=font">
                <i class="fa fa-font"></i>
                <p>Font</p>
                </a>
            </li>
            <li>
                <a href="http://localhost/html-php/index.php?1=editer&2=editer&3=vector">
                <i class="fa fa-stop"></i>
                <p>Vector</p>
                </a>
            </li>
            <li>
                <a href="http://localhost/html-php/index.php?1=editer&2=editer&3=3d">
    ...
    <header id="main_header">
        <h1><a href="http://localhost/html-php/index.php"><img src="CH/img/logo/lubycon_logo.svg" width="176" height="40" alt="main_logo" /></a></h1>
        <nav id="main_gnb">
            <ul id="gnb">
                <li class="bigsub">
                    Contents
                    <ul class="sub">
                        <li>
                            <a href="http://localhost/html-php/index.php?1=contents&2=contents_page&3=font"><i class="fa fa-font fa-1x"></i><p>Font</p></a>
                        </li>
                        <li>
                            <a href="http://localhost/html-php/index.php?1=contents&2=contents_page&3=vector"><i class="fa fa-square fa-1x"></i><p>Vector</p></a>
                        </li>
                        <li>
                            <a href="http://localhost/html-php/index.php?1=contents&2=contents_page&3=3d"><i class="fa fa-cube fa-1x"></i><p>3D</p></a>
                        </li>
                ...
                <li class="bigsub">
                    ...
                    <ul class="sub">
                        <li>
                            <a href="http://localhost/html-php/index.php?1=community&2=community_page"><i class="fa fa-comments-o fa-1x"></i><p>Board</p></a>
                        </li>
                        <li>
                            <a href="http://localhost/html-php/index.php?1=community&2=tutorial"><i class="fa fa-book fa-1x"></i><p>Tutorial</p></a>
                        </li>
                        <li>
                            <a href="http://localhost/html-php/index.php?1=community&2=qna"><i class="fa fa-question fa-1x"></i><p>Q&amp;A</p></a>
                        </li>
                        <li>
                            <a href="http://localhost/html-php/index.php?1=designers_page&2=designers_page"><i class="fa fa-star fa-1x"></i><p class="long_text">Designers Page</p></a>
                        </li>
                ...
                <li class="bigsub">
                    ...
                    <ul class="sub">
                        <li>
                            <a href="http://localhost/html-php/index.php?1=company&2=about_us"><i class="fa fa-building fa-1x"></i><p>About us</p></a>
                        </li>
                    </ul>	<!--end Company menu-->
                </li>
            </ul> <!-- end gnb ul -->
        ...
        <div id="after_signin">
            ...
            <ul>
                <li><a href="http://localhost/html-php/index.php?1=personal_page&2=personal_page">Profile</a></li>
                <li><a href="http://localhost/html-php/index.php?1=personal_page&2=message">Message</a></li>
                <li><a href="http://localhost/html-php/index.php?1=personal_page&2=account_setting">Account Setting</a></li>
