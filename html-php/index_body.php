...
<!-- FlexSlider apply code -->
    ...
    <section id="slide_section">
        ...
        <div id="slider1" style="  width: 980px; height: 363px;  ">
            ...
            <span u="arrowright" class="slider_arrow_right">
        	 ...
        	 <!-- end slider1 div -->
        <div id="slider2" style="  width: 980px; height: 363px;  ">
            <div class="slides" u="slides">
                <div>
                    <ul>
                        <li><img src="ch/img/slider/slider2/1.png" alt="½æ³×ÀÏ02"></li>
                        <li><img src="ch/img/slider/slider2/2.png" alt="½æ³×ÀÏ02"></li>
                        <li><img src="ch/img/slider/slider2/3.png" alt="½æ³×ÀÏ02"></li>
                        <li><img src="ch/img/slider/slider2/4.png" alt="½æ³×ÀÏ04"></li>
                        <li><img src="ch/img/slider/slider2/5.png" alt="½æ³×ÀÏ05"></li>
                        <li><img src="ch/img/slider/slider2/6.png" alt="½æ³×ÀÏ06"></li>
                        <li><img src="ch/img/slider/slider2/7.png" alt="½æ³×ÀÏ07"></li>
                        <li><img src="ch/img/slider/slider2/8.png" alt="½æ³×ÀÏ08"></li>
                        <li><img src="ch/img/slider/slider2/9.png" alt="½æ³×ÀÏ07"></li>
                        <li><img src="ch/img/slider/slider2/10.png" alt="½æ³×ÀÏ08"></li>
                    </ul>
                </div>
                <div>
                    <ul>
            ...
            <span u="arrowright" class="slider_arrow_right">
        	 ...
        	 <!-- end slider2 div -->
        <div id="slider3" style="  width: 980px; height: 363px;  ">
            <div class="slides" u="slides">
                <div>
                    <ul>
                        <li><img src="ch/img/slider/slider3/1.png" alt="½æ³×ÀÏ02"></li>
                        <li><img src="ch/img/slider/slider3/2.png" alt="½æ³×ÀÏ02"></li>
                        <li><img src="ch/img/slider/slider3/3.png" alt="½æ³×ÀÏ02"></li>
                        <li><img src="ch/img/slider/slider3/4.png" alt="½æ³×ÀÏ04"></li>
                        <li><img src="ch/img/slider/slider3/5.png" alt="½æ³×ÀÏ05"></li>
                        <li><img src="ch/img/slider/slider3/6.png" alt="½æ³×ÀÏ06"></li>
                        <li><img src="ch/img/slider/slider3/7.png" alt="½æ³×ÀÏ07"></li>
                        <li><img src="ch/img/slider/slider3/8.png" alt="½æ³×ÀÏ08"></li>
                        <li><img src="ch/img/slider/slider3/9.png" alt="½æ³×ÀÏ07"></li>
                        <li><img src="ch/img/slider/slider3/10.png" alt="½æ³×ÀÏ08"></li>
                    </ul>
                </div>
                <div>
                    <ul>
        ...
        <section id="designer_month"><!--designer of the month start-->
        <article id="designer_title">DESGINER OF THE MONTH</article>
    ...
    </section><!--designer of the month end-->
    
    <section id="community_pre"><!--community preview start-->
        <article id="designer_title">HOT TOPICS IN <font color="#48cfad">AUGUST</font></article>
        <ul>
            <li class="forum_card"><!-- card list start-->
                    <div class="f_card_body"><!--card start-->
                        <a href="#"><!--link start-->
