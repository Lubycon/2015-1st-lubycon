...
<img src="img/top_bg.gif" alt="top" /><div id="main" class="container">
    ...
    <ul id="navigation">
    <li><a href="./index.php?1=contents&2=contents_page&3=font">Page 1</a></li>
    <li><a href="./index.php?1=community&2=community_page">Page 2</a></li>
    <li><a href="./index.php?1=about&2=about_us">Page 3</a></li>
