<div id="pop_up">
    ...
    <section class="contents_view">
        ...
        <aside class="con_right">
            ...
            <button class="share_sns share_face"><i class="fa fa-facebook"></i>Sharing on Facebook</button>
            <button class="share_sns share_twit"><i class="fa fa-twitter"></i>Sharing on twitter</button>
