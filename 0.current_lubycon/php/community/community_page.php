        ...
        <div class="tab_item" id="table1">
            <table>
                <thead>
                    ...
                    <th class="table_like"><i class="fa fa-heart"></i></th>
                    <!-- heart icon -->
                    <th class="table_view"><i class="fa fa-eye"></i></th>
                    <!-- eye icon -->
                    <th class="table_date">DATE</th>
                </thead>
                <tbody class="table_body">
                    <tr>
                        <td class="table_blank"><i class="fa fa-circle"></i></td>
                        <!-- space -->
                        <td class="table_number">125</td>
                        <!-- number -->
                        <td class="table_subject">Lubycon opens on may [1]</td>
                        <!-- subject -->
                        <td class="table_writer">John Snow</td>
                        <!-- writer -->
                        <td class="table_like">123</td>
                        <!-- like -->
                        <td class="table_view">45.2K</td>
                        <!-- view -->
                        <td class="table_date">15.05.24</td>
                        <!-- date -->
                    </tr>
                    <!-- 1 -->
                    <tr>
