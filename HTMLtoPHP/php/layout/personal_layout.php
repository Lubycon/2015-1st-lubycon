<section id="navsel">
    <nav id="lnb_nav">
        <ul>
            <li class="selected_nav"><a href="./index.php?1=personal_page&2=personal_page">Main</a></li>
            <li><a href="./index.php?1=personal_page&2=insight">Insight</a></li>
            <li><a href="./index.php?1=personal_page&2=followers">Followers</a></li>
        </ul>
    </nav>
    <!-- end lnb nav -->
</section>
